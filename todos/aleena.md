...
- [ ] Smoke-test against Charvi's Vercel frontend once it exists — set `CORS_ORIGIN` env var (`railway variables --set CORS_ORIGIN=<her URL>`) to replace the current wildcard `*`
