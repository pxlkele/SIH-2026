...
- [x] Told Palak the backend is live and sent the URL (2026-09-04) — her todo checkbox will presumably follow once she updates it.
...
- [x] `CORS_ORIGIN` now accepts a comma-separated list, not just one string — **now actually locked down** to `https://beacon-sih.vercel.app,http://localhost:5173` (see Deploy section above) now that the frontend URL exists
